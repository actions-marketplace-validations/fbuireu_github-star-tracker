...
- Coverage floor of 85% for lines, functions, branches and statements, enforced by the threshold in [`vitest.config.mts`](https://github.com/fbuireu/github-star-tracker/blob/main/vitest.config.mts). The build fails below it
